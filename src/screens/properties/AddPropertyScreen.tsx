...
export function AddPropertyScreen() {
  ...
  const renderPropertyTypeButton = (item: PropertyTypeOption) => {
    ...
    return (
      ...
      >
        <IconComponent size={24} color={isSelected ? COLORS.primary[isDark ? 400 : 600] : color} />
        <Text
  ...
  const propertyTypeColor = PROPERTY_TYPES[type]?.color || COLORS.slate[500];
            ...
            {imageUri ? (
              ...
              <View className="items-center">
                <View
                  ...
                  style={{ backgroundColor: `${propertyTypeColor}20` }}
                >
